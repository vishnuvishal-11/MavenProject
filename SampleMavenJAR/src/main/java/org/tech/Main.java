...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        try (FileWriter writer = new
              FileWriter("C:\\Users\\vishn\\IdeaProjects\\SampleMavenJAR\\target\\classes\\org\\tech\\m.json"))
      {
          gson.toJson(mo, writer);}
      catch (Exception e){
          e.printStackTrace();
      }
        String s=gson.toJson(mo);
    ...
    void display(){
        ...
        System.out.println("class Executes sucessfully");
    }
}